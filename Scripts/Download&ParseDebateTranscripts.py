...
print len(urllist)
a = urllist.index("http://www.presidency.ucsb.edu/ws/index.php?pid=112719") #Last Democratic debate link. Output is 40.#
b = urllist.index("http://www.presidency.ucsb.edu/ws/index.php?pid=110903") #First Democratic debate link. Output is 47.#
c = urllist.index("http://www.presidency.ucsb.edu/ws/index.php?pid=111711") #Last Republican debate link. Output is 48.#
d = urllist.index("http://www.presidency.ucsb.edu/ws/index.php?pid=110757") #First Republican debate link. Output is 65.# 
print a,b,c,d
...
# Converting from unicode to string. Might not be needed.#
#hereiam = []
#def convert(x):
#	global hereiam
#	for i in x:
